...
insert into INTERVENTO(ID, TIPO, DATA_E_ORA, DURATA, SALA_OP, CF_PAZ) values(100,'CHIRURGIA GENERALE',to_date('02/05/2009 12:00:00','dd/mm/yyyy HH24:mi:ss'),2,'SALA UNO','AAA0000000000001');

insert into INTERVENTO(ID, TIPO, DATA_E_ORA, DURATA, SALA_OP, CF_PAZ) values(101,'CHIRURGIA PLASTICA',to_date('07/05/2009 12:00:00','dd/mm/yyyy HH24:mi:ss'),3,'SALA DUE','AAA0000000000002');

insert into INTERVENTO(ID, TIPO, DATA_E_ORA, DURATA, SALA_OP, CF_PAZ) values(102,'CHIRURGIA GENERALE',to_date('08/05/2009 15:00:00','dd/mm/yyyy HH24:mi:ss'),4,'SALA TRE','AAA0000000000003');

insert into INTERVENTO(ID, TIPO, DATA_E_ORA, DURATA, SALA_OP, CF_PAZ) values(103,'LASER',to_date('11/05/2009 09:00:00','dd/mm/yyyy HH24:mi:ss'),1,'SALA UNO','AAA0000000000004');

insert into INTERVENTO(ID, TIPO, DATA_E_ORA, DURATA, SALA_OP, CF_PAZ) values(104,'CHIRURGIA GENERALE',to_date('13/03/2009 13:00:00','dd/mm/yyyy HH24:mi:ss'),2,'SALA DUE','AAA0000000000005');

insert into INTERVENTO(ID, TIPO, DATA_E_ORA, DURATA, SALA_OP, CF_PAZ) values(105,'LASER',to_date('14/04/2009 11:00:00','dd/mm/yyyy HH24:mi:ss'),1,'SALA TRE','AAA0000000000016');

insert into INTERVENTO(ID, TIPO, DATA_E_ORA, DURATA, SALA_OP, CF_PAZ) values(106,'CHIRURGIA GENERALE',to_date('11/05/2009 15:00:00','dd/mm/yyyy HH24:mi:ss'),3,'SALA UNO','AAA0000000000017');

insert into INTERVENTO(ID, TIPO, DATA_E_ORA, DURATA, SALA_OP, CF_PAZ) values(107,'LASER',to_date('17/04/2009 10:00:00','dd/mm/yyyy HH24:mi:ss'),5,'SALA DUE','AAA0000000000018');

insert into INTERVENTO(ID, TIPO, DATA_E_ORA, DURATA, SALA_OP, CF_PAZ) values(108,'CHIRURGIA GENERALE',to_date('17/04/2009 11:00:00','dd/mm/yyyy HH24:mi:ss'),3,'SALA UNO','AAA0000000000019');

insert into INTERVENTO(ID, TIPO, DATA_E_ORA, DURATA, SALA_OP, CF_PAZ) values(109,'CHIRURGIA PLASTICA',to_date('17/04/2009 15:00:00','dd/mm/yyyy HH24:mi:ss'),2,'SALA TRE','AAA0000000000020');

insert into INTERVENTO(ID, TIPO, DATA_E_ORA, DURATA, SALA_OP, CF_PAZ) values(110,'MASTECTOMIA',to_date('10/05/2009 18:00:00','dd/mm/yyyy HH24:mi:ss'),2,'SALA TRE','AAA0000000000020');

insert into INTERVENTO(ID, TIPO, DATA_E_ORA, DURATA, SALA_OP, CF_PAZ) values(111,'CHIRURGIA GENERALE',to_date('19/03/2009 11:00:00','dd/mm/yyyy HH24:mi:ss'),1,'SALA TRE','AAA0000000000016');

insert into INTERVENTO(ID, TIPO, DATA_E_ORA, DURATA, SALA_OP, CF_PAZ) values(105,'LASER',to_date('15/05/2009 11:00:00','dd/mm/yyyy HH24:mi:ss'),1,'SALA DUE','AAA0000000000018');
